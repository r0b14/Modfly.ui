...
// Tooltip: balão amarelo com seta triangular.
...
export const TooltipLegacy: React.FC<TooltipLegacyProps> = ({
  content,
  position = 'center',
  text,
  width,
      ...
      <span ref={triggerRef} style={{ position: 'relative', display: 'inline-block' }}>
        ...
        >
          ...
          >
            ...
            <rect x="0" y="0" width="100%" height="3" fill="url(#dotted-underline-legacy)" />
          </svg>
        </span>
          ...
          >
            ...
            <div
              style={{
                ...
                minHeight: '103px',
                padding: typeof window !== 'undefined' && window.innerWidth <= 425 ? '12px' : typeof window !== 'undefined' && window.innerWidth <= 768 ? '16px' : '20px',
                background: bgColor,
