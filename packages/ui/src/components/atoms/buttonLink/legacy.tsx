...
// ButtonLink: todas as combinações variant (click/doc/vídeo) × colorScheme (azul/amarelo/rosa).
...
export interface ButtonLinkLegacyProps {
...
export const ButtonLinkLegacy: React.FC<ButtonLinkLegacyProps> = ({
  variant,
  colorScheme = 1,
  text,
  textColor,
