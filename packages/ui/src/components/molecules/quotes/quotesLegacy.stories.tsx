...
import { QuotesLegacy } from "./legacy";

const meta: Meta<typeof QuotesLegacy> = {
  title: "Molecules/QuotesLegacy",
  component: QuotesLegacy,
  tags: ["autodocs"],
  argTypes: {
    colorScheme: {
      control: "radio",
...
export default meta;
type Story = StoryObj<typeof QuotesLegacy>;
