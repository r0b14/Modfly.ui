...
import { CardsLegacy } from "./legacy";

const meta: Meta<typeof CardsLegacy> = {
  title: "Molecules/CardsLegacy",
  component: CardsLegacy,
  tags: ["autodocs"],
};

export default meta;
type Story = StoryObj<typeof CardsLegacy>;
