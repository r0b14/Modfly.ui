...
// Versão anterior ao redesign EDC (2026-07), mantida propositalmente ao lado do novo
// Cards: cards claros com faixa no topo e expansão em largura total (desktop) ou abaixo do card (mobile).
