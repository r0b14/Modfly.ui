...
export const Glossary: React.FC<GlossaryProps> = ({
  ...
  return (
    ...
    >
      <span
        ref={triggerRef} role="button" tabIndex={0} aria-expanded={isVisible} aria-describedby={isVisible ? tooltipId : undefined}
      ...
      {isVisible && (
        <div
          id={tooltipId} role="tooltip" className={`absolute z-50 bg-[#F2F2F2] text-[#333333] p-6 rounded-xl shadow-xl w-64 md:w-80 transition-all duration-200 ${
