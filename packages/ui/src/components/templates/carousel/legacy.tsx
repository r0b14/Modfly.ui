...
// Carousel: wrapper genérico sem estilo visual próprio, seta simples em preto.
import arrowIcon from './assets/arrowLegacy.svg';
...
export const CarouselLegacy: React.FC<CarouselLegacyProps> = ({
  items,
  numberOfItems,
  bgImages,
  bgColor = "transparent",
