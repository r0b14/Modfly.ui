...
import { CarouselLegacy } from "./legacy";

const meta: Meta<typeof CarouselLegacy> = {
  title: "Templates/CarouselLegacy",
  component: CarouselLegacy,
  tags: ["autodocs"],
};

export default meta;
type Story = StoryObj<typeof CarouselLegacy>;
