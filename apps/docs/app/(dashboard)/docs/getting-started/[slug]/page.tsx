        ...
        <div className="min-w-0 px-10">
          <header className="doc-head">
            ...
            <p className="doc-lead">
              A <strong>Modfly UI</strong> é uma biblioteca de componentes React projetada
              especificamente para o ecossistema de e-learning e cursos estruturados.
            </p>
          </header>
          ...
          <article className="doc-prose">
            <section id="philosophy">
              ...
              <p className="doc-p">
                Diferente de bibliotecas genéricas, a Modfly foca na hierarquia de informação
                necessária para o ensino. Nossos componentes são pensados para reduzir a carga
                cognitiva, destacando citações, blocos de reflexão e transições de conteúdo.
              </p>
              <ul className="prose-ul">
                <li className="prose-li">
                  <strong>Acessibilidade primeiro:</strong> Navegação por teclado e suporte a
                  leitores de tela em componentes complexos.
                </li>
                <li className="prose-li">
                  <strong>Escalabilidade:</strong> Cresce junto com a complexidade do seu curso.
                </li>
                <li className="prose-li">
                  <strong>Opinionated, but flexible:</strong> Design system pronto para uso, mas
            ...
            <section id="structure">
              ...
              <p className="doc-p">
                Organizamos nossos componentes seguindo a metodologia Atomic Design, facilitando a
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
                ...
                <div className="p-6 bg-[var(--paper)] border border-rule rounded-xl">
                  ...
                  <p className="text-sm text-[var(--muted)]">
                    Accordions complexos e blocos de aprendizagem.
                  </p>
                </div>
                <div className="p-6 bg-[var(--paper)] border border-rule rounded-xl">
                  <h4 className="font-bold mb-2">Templates</h4>
                  <p className="text-sm text-[var(--muted)]">
                    Carousels, banners de unidade e paginação.
                  </p>
                </div>
              </div>
            </section>
        ...
        <div className="min-w-0 px-10">
          ...
          <article className="doc-prose">
            <section id="content">
              ...
              <p className="doc-p">
                Como mencionado na instalação, o passo mais importante é garantir que o Tailwind
                faça o scan dos arquivos compilados da biblioteca:
              </p>
              <DocCodeBlock
            ...
            <section id="customization">
              ...
              <p className="doc-p">
                Você pode estender as cores da Modfly no seu tema. Recomendamos usar os mesmos nomes
                de tokens para manter a consistência:
              </p>
              <DocCodeBlock
                filename="tailwind.config.ts"
                raw={`theme: {\n  extend: {\n    colors: {\n      primary: "#285C93",\n      secondary: "#6CA3E8",\n      accent: "#FFB861",\n    }\n  }\n}`}
              >
                <pre style={{ margin: 0 }}>
                  ...
                  {'\n'}
                  {'      '}
                  <span className="tok-attr">primary</span>:{' '}
                  <span className="tok-str">&quot;#285C93&quot;</span>,{'\n'}
                  {'      '}
                  <span className="tok-attr">secondary</span>:{' '}
                  <span className="tok-str">&quot;#6CA3E8&quot;</span>,{'\n'}
                  {'      '}
                  <span className="tok-attr">accent</span>:{' '}
                  <span className="tok-str">&quot;#FFB861&quot;</span>,{'\n'}
                  {'    '}
                  {'}'}
                  {'\n'}
                  {'  '}
      ...
      <div className="grid grid-cols-[1fr_260px] min-h-screen">
        <div className="min-w-0 px-10">
          <header className="doc-head">
            ...
            <p className="doc-lead">
              Customize as cores e estilos globais da Modfly UI para alinhar com a identidade visual
              do seu curso.
            </p>
          </header>
          ...
          <article className="doc-prose">
            <section id="css-variables">
              ...
              <p className="doc-p">
                A lib utiliza variáveis CSS no `:root` para definir sua paleta base. Você pode
                sobrescrevê-las no seu CSS global:
              </p>
              <DocCodeBlock
              ...
              >
                <pre style={{ margin: 0 }}>
                  ...
                  {'\n'}
                  {'  '}
                  <span className="tok-attr">--modfly-primary</span>:{' '}
                  <span className="tok-str">#1a365d</span>;{'\n'}
                  {'  '}
                  <span className="tok-attr">--modfly-secondary</span>:{' '}
                  <span className="tok-str">#2b6cb0</span>;{'\n'}
                  {'  '}
                  <span className="tok-attr">--modfly-accent</span>:{' '}
                  <span className="tok-str">#ed8936</span>;{'\n'}
                  {'  '}
                  <span className="tok-attr">--modfly-radius</span>:{' '}
                  <span className="tok-str">0.5rem</span>;{'\n'}
                  {'}'}
                </pre>
              </DocCodeBlock>
            </section>
        ...
        <RightToc
          entries={[{ id: 'css-variables', label: 'CSS Variables' }]}
          readTime="~2 min"
          editHref="https://github.com/r0b14/Modfly.ui"
        />
      </div>
      ...
      <div className="min-w-0 px-10">
        <header className="doc-head">
          ...
          <p className="doc-lead">
            ...
            <code className="font-jetbrains text-[13.5px]">&lt;UnityBanner /&gt;</code> renderizando
            na tela.
          </p>
        ...
        <article className="doc-prose">
          ...
          <section id="requirements">
            ...
            <p className="doc-p">
              Modfly UI roda em qualquer aplicação React 18+ com Tailwind. Não há dependências
              escondidas — a lib é <em>peer-dependency-only</em> em <code>react</code>,{' '}
              <code>react-dom</code> e <code>tailwindcss</code>.
            </p>
            ...
            <Callout variant="tip" label="Tip · pnpm é o gerenciador oficial">
              <p>
                O monorepo do Modfly usa <code>pnpm</code> + Turborepo. Os exemplos assumem pnpm,
                mas npm e yarn funcionam igual — só troque o comando.
              </p>
            </Callout>
          </section>
          ...
          <section id="install">
            ...
            <p className="doc-p">
              Escolha seu package manager. O pacote é menor que 80 kb gzipped e suporta ESM e CJS —
              sem configuração extra de bundler.
            </p>
            ...
            <p className="doc-p">
              Se você está escrevendo cursos para a plataforma AVAMEC do MEC, instale também o
              sub-pacote dedicado. Ele expõe <code>QuestionOption</code>,{' '}
              <code>QuestionMultipleAnswer</code>, etc., já integrados com a{' '}
              <code>BridgeRestApi</code>.
            </p>
          ...
          <section id="setup">
            ...
            <p className="doc-p">
              Três passos. Apenas o <strong>2</strong> é não-óbvio — sem ele, as classes Tailwind da
              lib não aparecem no bundle final do seu projeto.
            </p>
            ...
            <div className="steps">
              <div className="step">
                ...
                <p className="step-desc">
                  No seu arquivo de entrada (<code>main.tsx</code>, <code>_app.tsx</code> ou
                  equivalente), importe os estilos base. Eles incluem reset, fontes e tokens de
                  design.
                </p>
                <DocCodeBlock
                ...
                >
                  <pre style={{ margin: 0 }}>
                    ...
                    {'\n'}
                    <span className="tok-key">import</span> <span className="tok-tag">React</span>{' '}
                    ...
                    {'\n'}
                    <span className="tok-key">import</span> <span className="tok-fn">App</span>{' '}
                    <span className="tok-key">from</span>{' '}
              ...
              <div className="step">
                ...
                <p className="step-desc">
                  Adicione o caminho dos componentes ao array <code>content</code> para que o JIT do
                  Tailwind veja as classes usadas dentro do <code>@modfly/ui</code>.
                </p>
                <DocCodeBlock
                  filename="tailwind.config.ts"
                ...
                >
                  <pre style={{ margin: 0 }}>
                    <span className="tok-key">import</span> <span className="tok-key">type</span>{' '}
                    {'{ '}
                    ...
                    ,{'\n'}
                    {'    '}
                    <span className="tok-com">{'// 👇 obrigatório para classes da lib'}</span>
                    {'\n'}
                    {'    '}
                    <span className="tok-str">
                      &apos;./node_modules/@modfly/ui/dist/**/*.js&apos;
                ...
                <Callout variant="warn" label="Atenção · esquecer este passo é o erro #1">
                  <p>
                    Se os componentes aparecerem sem estilos, 100% das vezes é o{' '}
                    <code>content</code> do Tailwind faltando. Verifique o caminho em{' '}
                    <code>node_modules/@modfly/ui/dist</code>.
                  </p>
                </Callout>
              </div>
              ...
              <div className="step">
                ...
                <p className="step-desc">
                  Cole o trecho abaixo numa página qualquer. Você deve ver o banner roxo da unidade
                ...
                >
                  <pre style={{ margin: 0 }}>
                    ...
                    {'\n'}
                    {'      '}
                    <span className="tok-attr">number</span>={'{'}
            ...
            <Callout variant="tip" label="Pro tip · imports tree-shakeable">
              <p>
                ...
                <code>{"import { UnityBanner } from '@modfly/ui'"}</code> — o bundler descarta o
                resto. Sem barrel files quebrando o tree-shake.
              </p>
            </Callout>
          </section>
          ...
          <section id="verify">
            ...
            <p className="doc-p">
              Rode o seu dev server. Se tudo estiver no lugar, o banner abaixo renderiza com o
              gradiente roxo característico:
            </p>

            <div className="my-7 max-w-[720px] p-8 bg-[var(--paper)] border border-rule rounded-xl">
              <div
                style={{
                  background: 'linear-gradient(110deg, var(--purple) 0%, #4a2d8e 100%)',
                  color: 'white',
                  padding: '32px 28px',
                  borderRadius: '14px',
                  position: 'relative',
              ...
              <div className="mt-3.5 font-jetbrains text-[11px] text-[var(--muted)] tracking-[0.06em] mono">
                ↑ <span className="text-[var(--ink-2)]">&lt;UnityBanner /&gt;</span> renderizado
              </div>
            </div>

            <Callout variant="danger" label="Não está vendo nada?">
              <p>
                Se o componente aparece como texto cru ou sem estilo, abra o DevTools e procure
                pelas classes do Tailwind no HTML. Se estão lá mas sem efeito → <code>content</code>{' '}
                errado. Se nem estão → o import do CSS global está faltando.
              </p>
              <p>
          ...
          <section id="next">
            ...
            <p className="doc-p">Você tem o ambiente pronto. Algumas direções recomendadas:</p>
            <ul className="prose-ul">
              <li className="prose-li">
                <a
                  href="/docs/getting-started/tailwind-setup"
              ...
              <li className="prose-li">
                ...
                — como sobrescrever as 6 cores base da lib via CSS variables sem ejetar componentes.
              </li>
              <li className="prose-li">
                <a
                ...
                — catálogo completo dos 38+ componentes organizados por Atoms / Molecules /
                Organisms / Templates.
              </li>
            </ul>
          ...
          <footer className="pg-foot">
            ...
            <a href="https://github.com/r0b14/Modfly.ui" target="_blank" rel="noopener noreferrer">
              Edit this page ↗
            </a>
            <a
              href="https://github.com/r0b14/Modfly.ui/issues"
