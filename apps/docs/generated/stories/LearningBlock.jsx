...
export const Variante2 = { args: { ...Variante1.args, variant: 2 } };
export const Variante3 = { args: { ...Variante1.args, variant: 3 } };
export const Variante4 = { args: { ...Variante1.args, variant: 4 } };
export const Variante6 = { args: { ...Variante1.args, variant: 6 } };
export const Variante7 = { args: { ...Variante1.args, variant: 7 } };
export const Variante9 = { args: { ...Variante1.args, variant: 9 } };
export const Variante10 = { args: { ...Variante1.args, variant: 10 } };
