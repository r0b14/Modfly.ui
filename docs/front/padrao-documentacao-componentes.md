...
3. Executar `pnpm docs:generate` na raiz. O gerador lê stories e tipos TypeScript, cria o catálogo e as rotas estáticas.
4. Conferir contexto pedagógico, tipos, exemplo e demonstração no site.
...
Preservar a tipografia, tokens CSS, sidebar e sumário lateral existentes. No celular, a coluna de conteúdo precisa caber na tela; tabelas e código podem ter rolagem própria. Toda interação precisa ter rótulo e comportamento por teclado. Manter as descrições em PT-BR.
